...
class Storage {
  ...
  static clearAll() {
    ...
    // If you want to clear the limit too(use just this here):
    // localStorage.clear();
  }
}
...
class App {
  ...
  _setLimit(e) {
    e.preventDefault(); // cus is a form
...
// const lunch = new Meal('Lunch', 950);
